...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_create_new_question(self):
        new_question = {
            'question': 'new question for test',
            'answer': 'new answer for test',
            'difficulty': 1,
            'category': 1
        }
    ...
    def test_404_get_question_search_by_categories_without_results(self):
        res = self.client().get('/categories/bunnybear/questions')
        data = json.loads(res.data)
